...
public class TestEditorRunner : EditorBehaviourRunner
{
    ...
    public void StartAction() => Debug.Log("Start");
    public Status UpdateAction() => Status.Success;
    public void StopAction() => Debug.Log("Stop");
